...
import {BreakSchema, CorrectionSchema, StartShiftSchema, TabNumSchema} from "../validation/joiSchemas.js";
...
shiftRouter.post('/start_shift', queryValidation(StartShiftSchema), controller.startShift);
